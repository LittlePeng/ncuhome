...
{
    public class UserInfor_Head:SkinnedBlogWebControl
    {
        public UserInfor_Head()
        {
            SkinFileName = "UserInfor_Head.ascx";
            IsThemed = true;
        }
        protected override void InitializeSkin(System.Web.UI.Control Skin)
        {
            if (Ncuhome.Blog.Core.BlogContext.Current.ThemeName == "space")
            {
            ...
            if (Ncuhome.Blog.Core.BlogContext.Current.ThemeName == "baidu")
            {
                HttpContext.Current.Response.Write("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">");
            }
            if (Ncuhome.Blog.Core.BlogContext.Current.ThemeName == "X-sapce")
            {
            ...
            if (Ncuhome.Blog.Core.BlogContext.Current.ThemeName == "Lxblog")
            {
                HttpContext.Current.Response.Write("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3c.org/TR/1999/REC-html401-19991224/loose.dtd\">");
                HttpContext.Current.Response.Write("<HTML xmlns=\"http://www.w3.org/1999/xhtml\">");
            }
            if (Ncuhome.Blog.Core.BlogContext.Current.ThemeName == "blogbus")
            {
                HttpContext.Current.Response.Write("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3c.org/TR/1999/REC-html401-19991224/loose.dtd\">");
                HttpContext.Current.Response.Write("<HTML xmlns=\"http://www.w3.org/1999/xhtml\">");
            }
