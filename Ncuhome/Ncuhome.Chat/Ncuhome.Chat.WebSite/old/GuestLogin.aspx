			...
			<tr>
				...
				<table border="0" width="534" cellspacing="0" cellpadding="0" id="table52">
					<tr>
						...
						<p align="center">嘉宾用户名<font color="#666666">&nbsp; ：</font></td>
						<td class="style1">
						<asp:TextBox ID="TextBox_Username" runat="server" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; FONT-SIZE: 12px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; FONT-STYLE: normal; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; LIST-STYLE-TYPE: none; FONT-VARIANT: normal" size="21" name="UID2"></asp:TextBox>
						</td>
