	...
	public class AsyncTests : BaseTest
	{
        ...
        public void ExecuteReader()
        {
            ...
            try
            {
                MySqlCommand proc = new MySqlCommand("spTest", conn);
                proc.CommandType = CommandType.StoredProcedure;
                IAsyncResult iar = proc.BeginExecuteReader(null,null,CommandBehavior.Default);
                int count = 0;
                while (!iar.IsCompleted)
                {
                    count++;
        ...
        public void ThrowingExceptions()
        {
            ...
            IAsyncResult r = cmd.BeginExecuteReader(null, null, CommandBehavior.Default);
            try
            {
